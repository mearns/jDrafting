...
/**
 * A {@link com.brianmearns.jDrafting.geom.scalar.Scalar} representing the Cartesian distance between two
 * {@link Point} objects.
 */
public class TwoPointDistanceScalar extends TwoPointScalar {

    @Nullable
    private static TwoPointCoordinateFunction<Double> valueFunc = null;

    public TwoPointDistanceScalar(@NotNull Point pt1, @NotNull Point pt2) {
        super(pt1, pt2);
    }
    ...
    public static Scalar create(@NotNull Point pt1, @NotNull Point pt2) {
        return new TwoPointDistanceScalar(pt1, pt2);
    }
